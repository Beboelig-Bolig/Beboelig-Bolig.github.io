...
<h2 id="content">Husleiekontraktens innhold – 9 punkter du <u><i>bør</i></u> ha avklart</h2>
...
<p>
    <header class="major"><h3 id="content">1. Husleien</h3></header>
        <ul style="list-style-type:disc; margin-left:3.25em">
            <li><b>Husleien skal være et fastsatt, månedlig beløp.</b> Den skal ikke variere fra måned til måned, selv om utgiftene som utleier dekker, knyttet til boligen, gjør det. Tilleggsutgifter til vedlikehold, renovasjon, forsikring, vaktmester og lignende skal også være inkludert i selve leien, og utleier kan derfor ikke komme med regning til deg som leietaker. (NB! Unntakene er beskrevet i fjerde underpunkt).</li>
            ...
            <li><b>Sjekk husleiens rimelighet.</b> Beløpet skal være rimelig i forhold til markedspris. I forhold til boligens størrelse, beliggenhet, standard osv. skal månedsleien ikke være vesentlig lavere eller høyere enn hva en tilsvarende bolig ville blitt utleid på ved tidspunktet. Et tips kan være å undersøke andre lignende boliger på f.eks. Finn, Hybel eller spørre en du stoler på. Hvis du i forkant av kontraktsinngåelse synes leien er urimelig høy, kan du få den vurdert av en takstnemnd. Vær derimot oppmerksom på at etter at kontrakten er godtatt og signert, er leiesummen vanskelig å endre.</li>
            ...
            <ul style="list-style-type:disc; margin-bottom:0em; margin-left:3.25em">
                ...
                <li>Leietaker betaler for sin andel av utgiftene knyttet til vann og avløp. <i> NB! Merk at dette punktet kun gjelder dersom det finnes en måler som kan registrere forbruket.</i></li>
            </ul></li>
    ...
    <header class="major"><h3 id="content">2. Depositum</h3></header>
        <ul style="list-style-type:disc; margin-left:3.25em">
            ...
            <li><b>Depositum skal avklares før kontrakten inngås, ikke senere.</b> Når du utarbeider kontrakten, og blir enige om detaljene i den, skal depositum være nevnt i kontrakten. Huseier kan ikke kreve at det betales depositum i etterkant, da det er sent. </li>
            <li><b>Summen på depositumet kan være på maks seks ganger månedsleie.</b><span class="image right"><img src="https://img.freepik.com/free-vector/open-banking-data-access-financial-services-mobile-payment-app-development-api-technology-web-developers-designing-banking-platforms_335657-2401.jpg?w=1380&t=st=1681301193~exp=1681301793~hmac=dd0567bcf25d9924c96c85fd0178e2ae057f64344b00de6fbcc8654dcf496fe7" alt="" /></span>Det er opp til utleier å oppgi depositumets beløp, eller at dere blir enige om en sum. Det er ulikt fra utleier til utleier, men det er vanlig med en sum tilsvarende tre måneders leie. I praksis betyr dette at hvis du betaler 5 000 kr i husleie per måned, er depositumet på 15 000 kr. Det finnes ingen nedre ramme for depositum, men huseier har ikke lov til å kreve mer enn seks ganger månedsleie. Det vil si at i det samme eksempelet, kan huseier kreve maksimalt 30 000 kr i depositum. </li>
            ...
            <li><b>Depositumet fås tilbake ved å kontakte banken ved utflytting.</b> Har du opprettet en depositumskonto, kan du ta kontakt med banken din og kreve utbetaling av depositumet. Utleier får da fem uker på seg til å reise søksmål dersom dette skulle være aktuelt, ellers skal banken utbetale depositumet til deg. Er utleier uenig i at du skal ha det tilbake blir det reist et søksmål og du må delta på en rettslig prøving. Avgjørelsen som kommer frem i søksmålet vil avgjøre hvilken sum du får tilbake av depositumet. Har du betalt inn depositumet til huseierens private konto, er du nødt til å sende et krav om å få det tilbake. Dette kan være et varsel om at du ellers vil ta rettslige skritt. Om du ikke får depositumet tilbake må du klage til enten Husleietvistutvalget eller Forliksrådet. Hvilken av dem du skal kontakte kommer an på hvor du var bosatt under leieforholdet.</li>
            <li><b>Utleier kan holde tilbake depositum ved skade på bolig eller ubetalt husleie.</b>
                <ul style="list-style-type:algebraic; margin-bottom:0em; margin-left:3.25em;">
                    <li><b>Husleie er ikke betalt.</b> Hvis utleier mener at du ikke har betalt den husleien du skal, innen du skal, kan hen kreve å ta ut pengene fra depositumskontoen. Utleier kan da få pengene utbetalt dersom dere blir enige om at husleien ikke er betalt og avtaler at pengene skal tas fra depositumskontoen. Dersom du mener at du har betalt, kan ikke utleier be banken sette over pengene til seg selv med mindre utleier har bevist at du ikke har betalt skyldig husleie. I tillegg må banken ha sendt deg et skriftlig varsel om at dersom du er uenig må du legge inn klage på utleieren til <a href="https://www.htu.no">Husleietvistutvalget</a> eller <a href="https://forliksraadet.no">Forliksrådet</a> innen fem uker.</li>
    ...
    <header class="major"><h3 id="content">3. Varighet og oppsigelse</h3></header>
        <ul style="list-style-type:disc; margin-left:3.25em">
            <li><b>Varighet og oppsigelse for de to typene kontrakt.</b> En leiekontrakt kan deles inn i to kategorier; en tidsbestemt og en tidsubestemt kontrakt. <i>Den tidsbestemte kontrakten</i> har bestemt varighet, og da også en sluttdato, for eksempel fra 1. august 2023 - 31. juli 2026. <span class="image right"><img src="assets/images/wristwatch.png" alt="" /></span>Den kan ha uten eller med oppsigelse. Er ingenting om oppsigelse skriftlig avtalt, kan den sies opp. Den tidsbestemte kontraktene har som hovedregel en varighet på tre år. Unntak: Lofts- eller sokkelbolig i enebolig, halvparten av tomannsbolig og at huseier bor i den. I slike tilfeller kan leietiden være på ett år. <i>Den tidsubestemte kontrakten</i> har ingen sluttdato. Da står det heller at leieforholdet inngås for eksempel 1. august 2023. </li>
            <li><b>Generelt om <a href="https://www.htu.no/rettigheter-og-plikter/oppsigelse">oppsigelse</a>.</b> I kontrakten bør det stå spesifikke krav for oppsigelse, hvem som kan si opp og når det kan gjøres. Det er vanlig å inngå en avtale der begge har mulighet til å si opp, men det kan også stå at kun du, eller kun utleier har mulighet til å gjøre dette.</li>
            <li><b>Oppsigelse er en vanlig måte å avslutte en leieavtale i leieperioden.</b> Oppsigelsestiden er vanligvis på tre måneder og oppsigelsestiden starter fra den første dagen i måneden etter at oppsigelsen er gitt. Om man sier opp en dag i mars måned vil oppsigelsestiden starte 1. april og om oppsigelsestiden er på tre måneder vil den vare ut juni måned. Både rettighetene og pliktene til leietaker og utleier gjelder i oppsigelsestiden. </li>
            <li><b>Hvilke rettigheter utleier og leietaker har til å si opp leieavtalen står som oftest (og bør stå) i den skriftlige leiekontrakten.</b> Det er mulighet å avtale mellom utleier og leietaker hvordan leiekontrakten kan bli sagt opp og hvilken oppsigelsestid som skal gjelde. Det er også mulighet for å avtale mellomløsninger, som at man for eksempel ikke kan si opp leieavtalen det første året av leieperioden, men dette må da stå i leiekontrakten.</li>
        </ul>
    ...
    <header class="major"><h3 id="content">8. Linker til gode kontraktsmaler</h3></header>
        ...
        <ul style="list-style-type:disc; margin-left:3.25em">
            <li>Det finnes utallige gode maler for leiekontrakter som kan brukes. Selv om dette er maler, er det viktig å være kritisk og ta med det du synes er viktig for deg og din bosituasjon. Det er ofte utleier som tar ansvar for å ta i bruk en spesifikk kontrakt, men under kan du finne inspirasjon i fire kontraktsmaler som alle kan brukes:</li>
    ...
    <header class="major"><h3 id="content">9. Kosmetiske endringer i boligen</h3></header>
        <ul style="list-style-type:disc; margin-left:3.25em">
            <li>Utleieren vil som regel si hva som er lov og ikke vedrørende kosmetiske endringer i boligen avhengig av boligens tilstand. Som hovedregel bør man gå ut ifra at det i utgangspunktet ikke er lov å gjøre kosmetiske endringer i boligen du leier, uten godkjenning av utleier. En risikerer å måtte dekke kostnadene som følge av reparering eller tilbakeføring av hva som er utført dersom det gjøres uten samtykke fra utleier. Utleier må regne med normal slitasje ved utflytting, men det inngår ikke endringer man som leietaker utfører. </li>
            <li>Noen utleiere vil ofte godkjenne oppheng av "fast montasje" som gardinstenger eller bokhyller, mot at det blir værende i boligen og ikke medtas ved utflytting. Det kan derfor være lurt å avklare detaljer om dette på forhånd. <i>Husk! Som alt annet, unngå muntlige avtaler. Skriv alt ned i kontrakten for å unngå misforståelser og uforutsette kostnader.</i></li>
        </ul>
</p>
